...
import { MutedButton, PrimaryButton, SecondaryButton, TextButton } from '../components/UI/Buttons/ButtonTemplate'
...
import StudentClassCard from '../components/UI/Cards/StudentClassCard'
import { FlexRow, FlexColumn } from '../components/UI/Containers'
import BooleanRadio from '../components/UI/DataEntry/BooleanRadio'
import Form from '../components/UI/DataEntry/Form'
import InputField from '../components/UI/DataEntry/InputField'
import SearchBar from '../components/UI/DataEntry/SearchBar'
import Select from '../components/UI/DataEntry/Select'
import { StyledDatePicker } from '../components/UI/DataEntry/StyledDatePicker'
import { Option } from '../components/UI/DataEntry/StyledSelect'
import { StyledTextArea } from '../components/UI/DataEntry/StyledTextArea'
import GradingCell from '../components/UI/Grading/GradingCells'
import GradingSwitcher from '../components/UI/Grading/GradingSwitcher'
...
import AddSyllabusTopics from '../components/UI/Pages/AddSyllabusTopics'
...
import { StyledModaBox } from '../components/UI/StyledModalBox'
import { H1, H2, P1, P2, H4 } from '../components/UI/Typography'
import 'animate.css';
